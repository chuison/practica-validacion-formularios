//******************************************************************************
//Rellena el campo nombre empresa/particular en el caso de que  sea particulcar
//******************************************************************************
...
//*********************************************************************************************
      ...
      var buscarMunicipio = function(cp) {
          ...
          $.ajax({
              'type': 'POST',
              'url': 'http://luisalvarez.infenlaces.com/dwec/formulario/php/buscar_municipio_db.php',
              'data': {
                  inputCp: cp
              },
              'dataType': 'json'
